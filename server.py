# SGEA v0.35.14 — Servidor local: SQLite, autenticação, REST API, controle de estoque por lote (FEFO), backup automático
import http.server
import os
import json
import sqlite3
...
class SGEAHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def _route_put(self, p, body, s):
        ...
        if re.fullmatch(r'/api/entradas/[^/]+/restore', p):
            ...
            # Dados de Organização, que é aberta a qualquer usuário autenticado.
...
if __name__ == '__main__':
    ...
    try:
        ...
        sgx_base.servir_wsgi(SGEAHandler, '', PORT)
